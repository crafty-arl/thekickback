...
export function VenueDrawer({ venue, onClose }: VenueDrawerProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-x-0 bottom-0 z-50 flex flex-col rounded-t-[24px] border-t border-white/[0.15]"
      style={{
        height: "50dvh",
    ...
    >
      ...
      {/* Bottom bar: tabs + input inline */}
      <div
        className="relative flex items-center gap-2 px-3 pt-2"
                ...
                {isActive && (
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 8px ${vibeColor}15`,
                    }}
                    transition={{ type: "spring", damping: 25, stiffness: 300 }}
                  />
                )}
