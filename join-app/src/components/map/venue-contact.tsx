  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="relative z-10 w-full">
            <div className="mb-1.5 flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] text-white/40">{venue.occupancy}/{venue.capacity} · {pct}%</span>
            </div>
            ...
            {venue.neighborhood && <p className="mt-0.5 font-sans text-[10px] text-white/25">{venue.neighborhood}{venue.address ? ` · ${venue.address}` : ""}</p>}
          </div>
        </div>
      </div>
      ...
      <div className="mx-4 mb-4 flex gap-2">
        ...
        <button
          onClick={onChat}
          className="flex flex-1 items-center justify-center gap-2 rounded-xl py-3 font-sans text-[13px] font-bold text-black active:scale-[0.97]"
        ...
        <button
          ...
          className="flex h-12 w-12 items-center justify-center rounded-xl active:scale-[0.95]"
          style={{
            backgroundColor: isFavorite ? `${theme}15` : "rgba(255,255,255,0.04)",
            border: `1px solid ${isFavorite ? `${theme}30` : "rgba(255,255,255,0.06)"}`,
          }}
        >
          <svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
            fill={isFavorite ? theme : "none"}
            stroke={isFavorite ? theme : "rgba(255,255,255,0.3)"}
            strokeWidth="2"
            strokeLinecap="round"
        ...
        <button
          onClick={() => {
            ...
            const url = `https://join.thekickback.net/${slug}`;
            if (navigator.share) {
      ...
      {thread && (
        <div className="mx-4 mb-3">
          ...
          <button
            onClick={onChat}
            className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left active:scale-[0.98]"
      ...
      <div className="mx-4 mb-4 flex flex-col gap-1.5">
        {venue.address && (
          ...
          >
            ...
            <span className="font-sans text-[11px] text-white/40">{venue.address}</span>
