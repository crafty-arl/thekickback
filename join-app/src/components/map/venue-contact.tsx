...
export function VenueContact({ venue, onClose, onChat }: VenueContactProps) {
  ...
  return (
    ...
    >
      ...
      {/* Hero */}
      <div className="mx-4 mb-3 overflow-hidden " style={{ border: `1px solid ${theme}20` }}>
        <div
      ...
      <div className="mx-4 mb-3 flex gap-2">
        <button onClick={onChat} className="flex flex-1 items-center justify-center gap-2  py-3 font-sans text-[13px] font-bold text-black active:scale-[0.97]" style={{ backgroundColor: theme }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
          Chat
        </button>
        <button onClick={toggleFavorite} className="flex h-12 w-12 items-center justify-center  active:scale-[0.95]" style={{ backgroundColor: isFavorite ? `${theme}15` : "rgba(255,255,255,0.04)", border: `1px solid ${isFavorite ? `${theme}30` : "rgba(255,255,255,0.06)"}` }}>
      ...
      {(venue.address || venue.neighborhood) && (
        <a
          ...
          className="mx-4 mb-3 flex items-center gap-3  px-3 py-2.5 active:scale-[0.98]"
      ...
      {page?.hours && page.hours.length > 0 && (
        <div className="mx-4 mb-3  px-3 py-2.5" style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        <div className="mx-4 mb-3">
          ...
          {memberships.map((m) => (
            <button
              key={m.id}
              onClick={onChat}
              className="mb-1.5 flex w-full items-center gap-3  px-3 py-2.5 text-left active:scale-[0.98]"
          ...
          <div className="flex gap-1.5 overflow-x-auto no-scrollbar">
            {Object.entries(grouped).map(([type, items]) => (
              <button
                key={type}
                onClick={onChat}
                className="flex shrink-0 items-center gap-1.5  px-2.5 py-2 active:scale-95"
      ...
      <div className="mx-4 mb-3">
        <div className="mb-2 flex items-center justify-between">
          ...
          <button
            ...
            className=" px-2.5 py-1 font-sans text-[10px] font-bold active:scale-95"
        ...
        {/* Review form */}
        {showReviewForm && (
          <div className="mb-3  px-3 py-3" style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <textarea
              ...
              rows={2}
              className="w-full resize-none  px-3 py-2 font-sans text-[12px] text-white/80 placeholder:text-white/20 outline-none"
            ...
            <button
              ...
              className="mt-2 w-full  py-2 font-sans text-[12px] font-bold text-black active:scale-[0.98] disabled:opacity-40"
        ...
        {reviews.length > 0 ? (
          <div className="flex flex-col gap-2">
            {reviews.slice(0, 5).map((r) => (
              <div key={r.id} className=" px-3 py-2.5" style={{ backgroundColor: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.04)" }}>
      ...
      {thread && (
        <div className="mx-4 mb-3">
          ...
          <button onClick={onChat} className="flex w-full items-center gap-3  px-3 py-2.5 text-left active:scale-[0.98]" style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.05)" }}>
            <div className="flex h-9 w-9 shrink-0 items-center justify-center " style={{ backgroundColor: `${theme}12` }}>
      ...
      <div className="mx-4 mb-4">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3  px-3 py-2.5 active:scale-[0.98]"
          style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.05)" }}
        >
