...
export default async function SettingsPage() {
  ...
  const [venueRes, pageRes, knowledgeRes, membersRes, memberCountRes, offeringsRes, xpActionsRes, xpMilestonesRes, xpTemplatesRes, galleryRes, staffRes] = await Promise.all([
